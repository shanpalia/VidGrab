...
if (!source.includes('VIDGRAB_NATIVE_BROWSER_V1')) {
  ...
  const mainFields = `public class MainActivity extends BridgeActivity {
...
class VidGrabBrowserActivity extends android.app.Activity {
    ...
    private TextView textButton(String label) {
        ...
        v.setText(label);
        v.setTextSize(13);
        v.setTextColor(android.graphics.Color.DKGRAY);
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        forward.setBackgroundColor(android.graphics.Color.TRANSPARENT);
        reload = new ImageButton(this);
        reload.setImageResource(android.R.drawable.ic_popup_sync);
        reload.setBackgroundColor(android.graphics.Color.TRANSPARENT);

        address = new EditText(this);
        address.setSingleLine(true);
        address.setTextSize(14);
        address.setTextColor(android.graphics.Color.rgb(25, 35, 50));
        address.setHint("Search or enter URL");
        address.setPadding(dp(14), 0, dp(14), 0);
        address.setBackground(rounded(android.graphics.Color.rgb(245, 246, 248)));
        ...
        go.setTextColor(android.graphics.Color.rgb(220, 25, 35));
