...
if (fs.existsSync(gradleFile)) {
  ...
  // Configure Codemagic signing only when every required value exists.
  // GitHub Actions has no CM_* values, so it leaves Capacitor's release
  // configuration untouched and never evaluates file(null).
  const signingKeys = [
    'CM_KEYSTORE_PATH',
